# Awesome Infrastructure Security
This is a collection of resources and notes that I have used while studying the topic of Infrastructure Security. I hope you will find this useful in your work.
...
- [Chef](iac/chef.md)
- [Puppet](iac/puppet.md)
- [Vagrant](iac/vagrant.md)

## Secret Management
- [HashiCorp Vault](sm/vagrant.md)
- [Ansible Vault](sm/vagrant.md)
